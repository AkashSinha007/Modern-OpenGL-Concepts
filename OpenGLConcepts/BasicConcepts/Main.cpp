...
int main()
{
   ...
   // Model ourModel(FileSystem::getPath("resources/objects/backpack/backpack.obj"));
    Model ourModel1("face.obj");
    Model ourModel2("sukhoi.obj");
    ...
    char *containerTextureFileName = const_cast<char*>("container.jpg");
    containerTexture = Texture(containerTextureFileName);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        model3 = glm::translate(model3, cubePositions[4]);
        angle = 20.0f;
